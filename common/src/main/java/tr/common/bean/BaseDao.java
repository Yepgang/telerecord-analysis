...
import tr.common.api.Column;
import tr.common.api.Rowkey;
import tr.common.api.TableRef;
import tr.common.constant.Names;
import tr.common.constant.ValueConstant;
...
public abstract class BaseDao {
    ...
    protected void putData(Object obj) throws Exception {
        ...
        // 反射+annotation(用于区分rowkey和column)
        Class clazz = obj.getClass();
        TableRef tableRef = (TableRef)clazz.getAnnotation(TableRef.class);
        String tableName = tableRef.value();//这里获取tablename完全是炫技(
        ...
        Connection conn = getConnection();
        Table table = conn.getTable(TableName.valueOf(Names.TABLE.getValue()));
